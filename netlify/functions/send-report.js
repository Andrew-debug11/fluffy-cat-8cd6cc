  ...
  return `
    ...
    <body style="background:#080810;color:#F0EDE8;font-family:sans-serif;margin:0;padding:0;">
      <div style="max-width:600px;margin:0 auto;padding:32px 24px;">
        ...
        <p style="color:#8899AA;font-size:12px;text-align:center;margin-top:24px;line-height:1.6;">
          This report was generated by AI and is a solid starting point — not a guarantee. The $300 audit is reviewed line by line by a human before it reaches you.
        </p>
        <p style="color:#8899AA;font-size:12px;text-align:center;margin-top:12px;">
          Peninsulas AI · Downriver + Metro Detroit · <a href="https://peninsulasai.com" style="color:#8899AA;">peninsulasai.com</a>
        </p>
      </div>
    </body>
